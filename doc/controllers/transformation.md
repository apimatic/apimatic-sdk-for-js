...
| `exportFormat` | [`ExportFormats`](/doc/models/export-formats.md) | Form, Required | The desired API specification format for the transformation. <br>The format can be any of the [supported formats](https://docs.apimatic.io/api-transformer/overview-transformer#supported-input-formats). |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |
