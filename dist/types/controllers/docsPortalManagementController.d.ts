...
export declare class DocsPortalManagementController extends BaseController {
     ...
     * @return Response from the API call
     */
    generateBuildInputForUnpublishedPortal(apiGroupId: string, apiEntities?: string[], requestOptions?: RequestOptions): Promise<ApiResponse<unknown>>;
    /**
     * Generate Build Input for a Portal created using the UI workflow.  The Build Input will correspond to
     ...
     * @return Response from the API call
     */
    generateBuildInputForPublishedPortal(apiGroupId: string, apiEntities?: string[], requestOptions?: RequestOptions): Promise<ApiResponse<unknown>>;
    /**
