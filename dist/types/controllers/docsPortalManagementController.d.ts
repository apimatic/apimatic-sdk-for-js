...
export declare class DocsPortalManagementController extends BaseController {
     ...
     */
    publishHostedPortal(apiEntityId: string, requestOptions?: RequestOptions): Promise<ApiResponse<void>>;
    /**
     ...
     * @return Response from the API call
     */
    publishEmbeddedPortal(apiEntityId: string, requestOptions?: RequestOptions): Promise<ApiResponse<void>>;
    /**
     ...
     * @return Response from the API call
     */
    generateOnPremPortalViaBuildInput(contentType: ContentType, file: FileWrapper, requestOptions?: RequestOptions): Promise<ApiResponse<NodeJS.ReadableStream | Blob>>;
    /**
     ...
     * @return Response from the API call
     */
    generateBuildInputForUnpublishedPortal(apiGroupId: string, apiEntities?: string[], requestOptions?: RequestOptions): Promise<ApiResponse<unknown | undefined>>;
    /**
     * Generate Build Input for a Portal created using the UI workflow.  The Build Input will correspond to
     ...
     * @return Response from the API call
     */
    generateBuildInputForPublishedPortal(apiGroupId: string, apiEntities?: string[], requestOptions?: RequestOptions): Promise<ApiResponse<unknown | undefined>>;
    /**
     ...
     * @return Response from the API call
     */
    unpublishPortal(apiEntityId: string, requestOptions?: RequestOptions): Promise<ApiResponse<void>>;
}
//# sourceMappingURL=docsPortalManagementController.d.ts.map