...
export declare class CodeGenerationImportedApIsController extends BaseController {
     ...
     */
    generateSdk(apiEntityId: string, template: Platforms, requestOptions?: RequestOptions): Promise<ApiResponse<ApiEntityCodeGeneration>>;
    /**
     ...
     * @return Response from the API call
     */
    downloadSdk(apiEntityId: string, codegenId: string, requestOptions?: RequestOptions): Promise<ApiResponse<NodeJS.ReadableStream | Blob>>;
    /**
     ...
     * @return Response from the API call
     */
    listAllCodeGenerations(apiEntityId: string, requestOptions?: RequestOptions): Promise<ApiResponse<ApiEntityCodeGeneration[]>>;
    /**
     ...
     * @return Response from the API call
     */
    getACodeGeneration(apiEntityId: string, codegenId: string, requestOptions?: RequestOptions): Promise<ApiResponse<ApiEntityCodeGeneration>>;
    /**
