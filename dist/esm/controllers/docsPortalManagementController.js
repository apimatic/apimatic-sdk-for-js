 ...
 */
import { accept3Schema } from '../models/accept3';
...
export class DocsPortalManagementController extends BaseController {
     ...
     */
    async publishHostedPortal(apiEntityId, requestOptions) {
     ...
     * @return Response from the API call
     */
    async publishEmbeddedPortal(apiEntityId, requestOptions) {
        const req = this.createRequest('PUT');
        const mapped = req.prepareArgs({ apiEntityId: [apiEntityId, string()] });
     ...
     * @return Response from the API call
     */
    async generateOnPremPortalViaApiEntity(apiEntityId, accept, requestOptions) {
     ...
     * @return Response from the API call
     */
    async generateOnPremPortalViaBuildInput(contentType, file, requestOptions) {
        ...
        req.throwOn(422, ApiError, 'Unprocessable Entity - Contains error.zip for build issues');
     ...
     * @return Response from the API call
     */
    async generateBuildInputForUnpublishedPortal(apiGroupId, apiEntities, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
     ...
     * @return Response from the API call
     */
    async generateBuildInputForPublishedPortal(apiGroupId, apiEntities, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
            apiGroupId: [apiGroupId, string()],
            apiEntities: [apiEntities, optional(array(string()))],
     ...
     * @return Response from the API call
     */
    async unpublishPortal(apiEntityId, requestOptions) {
