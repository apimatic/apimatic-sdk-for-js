...
import { portalGenerationAsyncResponseSchema, } from '../models/portalGenerationAsyncResponse';
import { portalGenerationStatusResponseSchema, } from '../models/portalGenerationStatusResponse';
...
export class DocsPortalGenerationAsyncController extends BaseController {
     ...
     */
    async generateOnPremPortalViaBuildInputAsync(contentType, file, xApiMaticCallbackUrl, requestOptions) {
     ...
     * @return Response from the API call
     */
    async getPortalGenerationStatus(id, requestOptions) {
     ...
     * @return Response from the API call
     */
    async downloadGeneratedPortal(id, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({ id: [id, string()] });
