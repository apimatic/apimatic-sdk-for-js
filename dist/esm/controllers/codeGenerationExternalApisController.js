...
import { generateSdkViaUrlRequestSchema, } from '../models/generateSdkViaUrlRequest';
import { platformsSchema } from '../models/platforms';
import { userCodeGenerationSchema, } from '../models/userCodeGeneration';
...
export class CodeGenerationExternalApisController extends BaseController {
     ...
     */
    async generateSdkViaFile(accept, file, template, requestOptions) {
        const req = this.createRequest('POST', '/code-generations/generate-via-file');
     ...
     * @return Response from the API call
     */
    async generateSdkViaUrl(body, requestOptions) {
        const req = this.createRequest('POST', '/code-generations/generate-via-url');
        const mapped = req.prepareArgs({
     ...
     * @return Response from the API call
     */
    async downloadSdk(codegenId, requestOptions) {
     ...
     * @return Response from the API call
     */
    async listAllCodeGenerations(requestOptions) {
     ...
     * @return Response from the API call
     */
    async downloadInputFile(codegenId, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({ codegenId: [codegenId, string()] });
     ...
     * @return Response from the API call
     */
    async getACodeGeneration(codegenId, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({ codegenId: [codegenId, string()] });
     ...
     * @return Response from the API call
     */
    async deleteCodeGeneration1(codegenId, requestOptions) {
