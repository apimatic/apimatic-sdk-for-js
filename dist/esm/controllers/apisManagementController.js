...
import { acceptSchema } from '../models/accept';
import { accept2Schema } from '../models/accept2';
import { apiEntitySchema } from '../models/apiEntity';
import { contentTypeSchema } from '../models/contentType';
import { exportFormatsSchema } from '../models/exportFormats';
import { importApiVersionViaUrlRequestSchema, } from '../models/importApiVersionViaUrlRequest';
import { importApiViaUrlRequestSchema, } from '../models/importApiViaUrlRequest';
import { inplaceImportApiViaUrlRequestSchema, } from '../models/inplaceImportApiViaUrlRequest';
...
export class ApisManagementController extends BaseController {
     ...
     */
    async importAPIViaFile(contentType, file, requestOptions) {
     ...
     * @return Response from the API call
     */
    async importAPIViaURL(body, requestOptions) {
     ...
     * @return Response from the API call
     */
    async importNewAPIVersionViaFile(apiGroupId, accept, versionOverride, file, requestOptions) {
     ...
     * @return Response from the API call
     */
    async importNewAPIVersionViaURL(apiGroupId, accept, body, requestOptions) {
        const req = this.createRequest('POST');
        const mapped = req.prepareArgs({
            apiGroupId: [apiGroupId, string()],
            accept: [accept, acceptSchema],
     ...
     * @return Response from the API call
     */
    async inplaceAPIImportViaFile(apiEntityId, accept, file, requestOptions) {
     ...
     * @return Response from the API call
     */
    async inplaceAPIImportViaURL(apiEntityId, body, requestOptions) {
        const req = this.createRequest('PUT');
        const mapped = req.prepareArgs({
            apiEntityId: [apiEntityId, string()],
     ...
     * @return Response from the API call
     */
    async fetchAPIEntity(apiEntityId, requestOptions) {
     ...
     * @return Response from the API call
     */
    async downloadAPISpecification(apiEntityId, format, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
            apiEntityId: [apiEntityId, string()],
