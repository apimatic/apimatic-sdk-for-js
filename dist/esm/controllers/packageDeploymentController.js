 ...
 */
import { packageDeploymentInformationSchema, } from '../models/packageDeploymentInformation';
import { publishedPackageSchema, } from '../models/publishedPackage';
import { publishPackageInputSchema, } from '../models/publishPackageInput';
import { updatePackageDeploymentInformationSchema, } from '../models/updatePackageDeploymentInformation';
...
export class PackageDeploymentController extends BaseController {
     ...
     */
    async updatePackageDeploymentInformation(apiEntityId, body, requestOptions) {
     ...
     * @return Response from the API call
     */
    async packageDeploymentInformation(apiEntityId, requestOptions) {
     ...
     * @return Response from the API call
     */
    async getPublishedPackagesForAPI(apiEntityId, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({ apiEntityId: [apiEntityId, string()] });
     ...
     * @return Response from the API call
     */
    async publishAPackageForAPI(apiEntityId, body, requestOptions) {
     ...
     * @return Response from the API call
     */
    async getAPublishedPackage(apiEntityId, publishedPackageId, requestOptions) {
        const req = this.createRequest('GET');
        req.baseUrl('default');
        const mapped = req.prepareArgs({
            apiEntityId: [apiEntityId, string()],
