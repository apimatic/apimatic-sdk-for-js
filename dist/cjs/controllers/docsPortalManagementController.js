...
var internalServerErrorResponseError_1 = require("../errors/internalServerErrorResponseError");
    ...
    DocsPortalManagementController.prototype.generateOnPremPortalViaBuildInput = function (contentType, file, requestOptions) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                req.throwOn(400, problemDetailsError_1.ProblemDetailsError, 'Bad Request');
                ...
                req.throwOn(422, core_1.ApiError, 'Unprocessable Entity - Contains error.zip for build issues');
                req.throwOn(500, internalServerErrorResponseError_1.InternalServerErrorResponseError, 'Internal Server Error');
                req.authenticate([{ authorization: true }]);
