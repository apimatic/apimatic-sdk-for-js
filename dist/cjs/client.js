...
var Client = /** @class */ (function () {
    function Client(config) {
        ...
        this._userAgent = (0, core_3.updateUserAgent)('APIMatic CLI');
        this._requestBuilderFactory = createRequestHandlerFactory(function (server) { return getBaseUri(server, _this._config); }, (0, authentication_1.customHeaderAuthenticationProvider)({ 'Authorization': this._config.authorization }), new clientAdapter_1.HttpClient(core_4.AbortError, {
