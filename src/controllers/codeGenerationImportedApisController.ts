...
export class CodeGenerationImportedApisController extends BaseController {
   ...
   * @param template      The programming language for which to generate the SDK in. <br>The template can
   *                                   be any of the [supported templates](https://docs.apimatic.io/generate-
   *                                   sdks/overview-sdks/).
