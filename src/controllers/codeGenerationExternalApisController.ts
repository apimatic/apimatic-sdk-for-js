...
export class CodeGenerationExternalApisController extends BaseController {
  ...
  async generateSDKViaURL(
    ...
    const req = this.createRequest('POST', '/code-generations');
   ...
   * @param template The programming language for which to generate the SDK in. <br>The template can be
   *                                any of the [supported templates](https://docs.apimatic.io/generate-sdks/overview-
   *                                sdks/).
   * @return Response from the API call
   */
