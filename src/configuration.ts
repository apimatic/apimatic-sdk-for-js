...
export namespace Configuration {
  ...
  export function fromEnvironment(
    ...
    config.customUrl = envVariables.CUSTOM_URL;
    config.userAgent = envVariables.USER_AGENT;

    if (envVariables.AUTHORIZATION) {
...
const configurationSchema: Schema<Partial<Configuration>> = object({
  ...
  customHeaderAuthenticationCredentials: [
    'customHeaderAuthenticationCredentials',
    optional(object({ Authorization: ['Authorization', string()] })),
  ],
  httpClientOptions: [
    'httpClientOptions',
    optional(
  ...
  customUrl: ['customUrl', optional(string())],
